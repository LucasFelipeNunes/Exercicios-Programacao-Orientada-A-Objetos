...
Enunciado: 22) Escreva um programa em Java para gerar uma matriz (N x M) e outra (N
x P). Gerar uma terceira matriz (N x (M+P)), sendo que para cada linha inter-
calar suas respectivas colunas e apresentar as três matrizes.*/
import java.util.Scanner;
public class Lista0Exercicio22{
